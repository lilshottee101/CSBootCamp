...
search_losses() {
	...
	local dealers=$(awk -v time="$time" -v time_period="$time_period" '$1 == time && $2 == time_period {print $3, $4, $5, $6, $7, $8}' "${date}_Dealer_schedule.txt")
...
echo "The Black Jack Dealer was ${search_losses[0]} ${search_losses[1]}."
echo "The Roulette Dealer was ${search_losses[2]} ${search_losses[3]}."	
echo "The Texas Hold EM Dealer was ${search_losses[4]} ${search_losses[5]}."
